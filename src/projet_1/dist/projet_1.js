...
var machine_t = []; // Tableau vide au début (rien ne s'affiche)
var machine_i = NaN; // On pourrait mettre 0
var machine_n = NaN; // nombre d'élément du tableau
var machine_pos = NaN; // On a pas encore commencé à compter
var machine_neg = NaN; // On a pas encore commencé à compter
...
function afficherAlgorithme() {
    ...
    var algoX = 200, algoY = 50; // Coordonnées de la 1ère ligne de l'algorithme sur le canevas.
    var algoDY = 30; // Décalage vertical entre les lignes de l'algorithme.
...
function afficherVariable(x, y, valeur, titre) {
    ...
    var variableDX = 45, variableDY = 30; // Largeur et hauteur du rectangle.
    var valeurVariableDX = 20, valeurVariableDY = 20; // Décalage pour la valeur de la variable.
    var titreVariableDX = 20, titreVariableDY = 47; // Décalage pour le titre de la variable.
...
function afficherMachineVirtuelle() {
    ...
    var celluleDX = 50; // Décalage horizontal entre les cellules du tableau.
